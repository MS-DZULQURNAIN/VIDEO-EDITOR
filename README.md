...
`Warning` - There are two different branches available, go to [main](https://github.com/MS-DZULQURNAIN/VIDEO-EDITOR/tree/public) branch if you need bot for your `personal` needs.
